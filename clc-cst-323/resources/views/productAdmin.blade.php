...
<!-- 				Button to open product edit modal -->
				<td><button type="button" class="btn btn-primary" data-toggle="modal" href="#editModal{{$product['IDPRODUCT']}}">Edit</button></td>
			
<!-- 				Button to open the delete confirmation modal -->
				<td><button type="button" class="btn btn-primary" data-toggle="modal" href="#deleteModal{{$product['IDPRODUCT']}}">Delete</button></td>
